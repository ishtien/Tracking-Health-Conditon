...
namespace Project_menu
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            sr = new StreamReader("superstar.txt");
            superstar_idx=sr.ReadLine();
            sr.Close();

            pictureBox3.SizeMode = PictureBoxSizeMode.Zoom;
            //superstar_idx = @"superstar/" + superstar_idx;
            pictureBox3.Image = Image.FromFile(@"superstar/" + superstar_idx);
        ...
        public Form1()
        {
            ...
            選單ToolStripMenuItem.MouseLeave += toolStripMenuItem20_MouseLeave;

            toolStripMenuItem1.MouseEnter += toolStripMenuItem19_MouseEnter;
            toolStripMenuItem1.MouseLeave += toolStripMenuItem20_MouseLeave;
            ...
            toolStripMenuItem2.MouseLeave += toolStripMenuItem20_MouseLeave;
            toolStripMenuItem3.MouseLeave += toolStripMenuItem20_MouseLeave;
            toolStripMenuItem4.MouseLeave += toolStripMenuItem20_MouseLeave;
            toolStripMenuItem5.MouseLeave += toolStripMenuItem20_MouseLeave;
            toolStripMenuItem6.MouseLeave += toolStripMenuItem20_MouseLeave;
            ...
            toolStripMenuItem7.MouseLeave += toolStripMenuItem20_MouseLeave;
            ...
            toolStripMenuItem8.MouseLeave += toolStripMenuItem20_MouseLeave;
            toolStripMenuItem9.MouseLeave += toolStripMenuItem20_MouseLeave;
            toolStripMenuItem10.MouseLeave += toolStripMenuItem20_MouseLeave;
            toolStripMenuItem11.MouseLeave += toolStripMenuItem20_MouseLeave;
            toolStripMenuItem12.MouseLeave += toolStripMenuItem20_MouseLeave;
            ...
            toolStripMenuItem13.MouseLeave += toolStripMenuItem20_MouseLeave;
            ...
            toolStripMenuItem14.MouseLeave += toolStripMenuItem20_MouseLeave;
            toolStripMenuItem15.MouseLeave += toolStripMenuItem20_MouseLeave;
            toolStripMenuItem16.MouseLeave += toolStripMenuItem20_MouseLeave;
            toolStripMenuItem17.MouseLeave += toolStripMenuItem20_MouseLeave;
            toolStripMenuItem18.MouseLeave += toolStripMenuItem20_MouseLeave;
            ...
            toolStripMenuItem19.MouseLeave += toolStripMenuItem20_MouseLeave;
            toolStripMenuItem21.MouseLeave += toolStripMenuItem20_MouseLeave;
            toolStripMenuItem22.MouseLeave += toolStripMenuItem20_MouseLeave;
            toolStripMenuItem23.MouseLeave += toolStripMenuItem20_MouseLeave;
            toolStripMenuItem24.MouseLeave += toolStripMenuItem20_MouseLeave;
        ...
        public void setlab()
        {
            ...
            {
                lab[s].Location = new Point(pic[s].Location.X-11, pic[s].Location.Y + 50);
        ...
        public void draw_weight(int s)
        {
            ...
            else
            {
                ...
                bush = new SolidBrush(Color.Cyan);
                gra.FillEllipse(bush, 0, 0, 30, 30);
                draw_pt_s = new Point(pic[s - 1].Location.X, 16 + pic[s - 1].Location.Y);
        ...
        public void draw_bmi(int s)
        {
            if (s == 0)
            {
                ...
                bush = new SolidBrush(Color.Blue);
                gra.FillEllipse(bush, 0, 0, 30, 30);
                gra.DrawString((fbmi[s]).ToString(), this.Font, Brushes.White, 0, 10);
            }
            else
            {
        ...
        private void comboBox1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            pictureBox3.SizeMode = PictureBoxSizeMode.Zoom;
            string tmp = (comboBox1.SelectedIndex + 1) + ".jpg";
            //superstar_idx = @"superstar/" + superstar_idx;
            pictureBox3.Image = Image.FromFile(@"superstar/"+ tmp);
        ...
        private void button8_Click(object sender, EventArgs e)
        {
            ...
            tabPage3.Font = fontDialog1.Font;
